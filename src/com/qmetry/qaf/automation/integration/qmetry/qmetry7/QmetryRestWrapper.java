...
public class QmetryRestWrapper {
	 ...
	 * @return String
	 */
	public String doRequest(String uri, String method, Map<String, String> requestHeaders,
			String input) // $codepro.audit.disable
	{
		...
		try {
			...
			if (null != requestHeaders) {
				for (Iterator<Map.Entry<String, String>> it =
						requestHeaders.entrySet().iterator(); it.hasNext();) {
